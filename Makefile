...
PKG_HASH:=1a5f6e23997b45eb096b905d41fd2ab026063e7889d38c69694f2be69a74d712
...
define Build/Compile
	sed -i 's/^go .*/go 1.25/' $(PKG_BUILD_DIR)/go.mod
	cd $(PKG_BUILD_DIR); $(GO_PKG_VARS) $(USE_GOPROXY) go mod tidy
